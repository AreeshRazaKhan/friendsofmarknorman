...
export const ABOUT_META = [
  {
    label: "Service",
    value: "U.S. Navy",
    detail: "22 years active and reserve",
  },
  {
    label: "Practice",
    value: "Veterinary medicine",
    detail: "30 years · still operating in Washington County",
  },
  {
    label: "Family",
    value: "4 dogs",
    detail: "Doug the sheepadoodle leads the pack",
  },
...
export const ABOUT_BLOCKS = [
  ...
  },
  {
    number: "03",
    eyebrow: "Practice",
    title: "Change to to read 'Thirty years in Veterinary Medicine'",
