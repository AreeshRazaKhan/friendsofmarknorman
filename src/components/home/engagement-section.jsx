  ...
  return (
    <section id="get-involved" className="bg-paper-2">
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-10 lg:py-28">
        ...
        <dl className="mt-12 grid gap-x-10 gap-y-8 border-t border-bone pt-10 sm:grid-cols-3">
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1.2fr_1fr] lg:items-center lg:gap-16">
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-prose text-paper-78">
                Door-knock, make a call, host a coffee, drop a yard sign. Pick whatever fits — every
                bit moves the field.
              </p>
            ...
            <ul className="grid gap-3 border-t border-paper-78/20 pt-6 text-sm leading-relaxed text-paper-78 lg:border-t-0 lg:border-l lg:pl-10 lg:pt-0">
