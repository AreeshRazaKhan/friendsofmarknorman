  ...
  return (
    <>
      <PageHero
        ...
        title="What needs <em>fixing?</em>"
        lead="The most useful thing a campaign hears is what's actually broken in the district. Send a short note — the team triages every submission and Mark sees the patterns."
      />
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1fr_1.4fr] lg:gap-16 lg:px-10 lg:py-28">
          ...
          <div className="rounded-2xl border border-bone bg-white p-8 lg:p-10">
            ...
            <h3 className="display mt-3 text-2xl text-navy sm:text-3xl">
              Tell us <em>what&apos;s up.</em>
            </h3>
            <p className="mt-3 text-sm text-stone-dark">
              We read every submission. Sensitive issues are handled in confidence.
            </p>
            <div className="mt-6">
              <IssueForm />
            </div>
